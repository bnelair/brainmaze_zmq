...
project = 'BrainMaze: A Toolbox to Analyze Brain Electrophysiology, Behavior and Dynamics - ZMQ'
...
html_theme_options = {
    ...
    'navigation_depth': 5,
    "repository_url": "https://github.com/bnelair/brainmaze_zmq",
